...
import com.nebhale.newrelicservicebroker.catalog.CatalogFactory;
import com.nebhale.newrelicservicebroker.catalog.NewRelicPlan;
...
final class BindingController {
    ...
    BindingResponse create(@RequestBody BindingRequest bindingRequest) {
        ...
        return new BindingResponse(new Credentials(plan.getLicenseKey()), null);
    }
